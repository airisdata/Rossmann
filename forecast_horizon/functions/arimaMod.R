...
#save(all_models_arima, file = file.path(rossmann_data_path, "ARIMA_data", "all_arima_models.Rdata"))
#load(file.path(rossmann_data_path, "ARIMA_data", "all_arima_models.Rdata"))
